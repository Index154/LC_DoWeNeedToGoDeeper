...
public class ConfigManager {
    ...
    internal void Setup(ConfigFile configFile) {
        ...
        disableIfApparatusTaken = configFile.Bind("Other", "Disable entrance controls after Apparatus is grabbed", false, "If true, everyone can exit and enter using any door after the Apparatus is taken by a player");

        disableIfBreakerBoxDisabled = configFile.Bind("Other", "Disable entrance controls while the breaker box is turned off", false, "If true, everyone can exit and enter using any door while power in the facility is turned off through the breaker box (or if the moon started with the power turned off)");
